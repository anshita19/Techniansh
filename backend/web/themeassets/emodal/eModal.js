    ...
    define(['jquery'], function ($) {
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                ...
                + ' <div class=modal-header bg-teal><button type=button class="x close" data-dismiss=modal><span aria-hidden=true>&times;</span><span class=sr-only>Close</span></button><h5 class=modal-title></h5></div>'
                + '</div>'
                + '</div>'
                + '</div>')
