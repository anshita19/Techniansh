...
/**
 * UsertimestampBehavior automatically fills the specified attributes with the current timestamp.
 *
 * To use TimestampBehavior, insert the following code to your ActiveRecord class:
 *
 * ```php
 * use yii\behaviors\UsertimestampBehavior;
 *
 ...
 * ```
 *
 * By default, UsertimestampBehavior will fill the `created_at` and `updated_at` attributes with the current timestamp
 ...
 *     return [
 *         [
 *             'class' => UsertimestampBehavior::className(),
 ...
 * @since 2.0
 */
class UsertimestampBehavior extends AttributeBehavior
{
    /**
     ...
     */
    public $updatedAtAttribute = 'modified_at';
    /**
     * @inheritdoc
     *
